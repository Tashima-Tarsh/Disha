    ...
    <main className={styles.shell}>
      <section className={styles.card}>
        <div className={styles.identity}>
          ...
          <p>DISHA 6.6</p>
          <h1>Access the governed workbench</h1>
          <p className={styles.summary}>
            A civic-grade access gateway for mobile OTP, institutional identity, and secure development sign-in.
          </p>
        </div>
        ...
        <div className={styles.providerGrid}>
          <button className={styles.providerButton} data-active={mode === "meri-pehchan"} type="button" onClick={() => startProvider("meri-pehchan")}>
            <Building2 size={19} />
            <span><strong>Meri Pehchan</strong><small>National identity provider</small></span>
          </button>
          <button className={styles.providerButton} data-active={mode === "intra-id"} type="button" onClick={() => startProvider("intra-id")}>
            <Landmark size={19} />
            <span><strong>Intra ID</strong><small>Institutional access</small></span>
          </button>
        </div>
        ...
        <div className={styles.modeTabs} role="tablist" aria-label="Login methods">
          ...
          <button data-active={mode === "password"} type="button" onClick={() => setMode("password")}><KeyRound size={16} /> Secure fallback</button>
        </div>
        ...
        {mode === "mobile" ? (
          <form className={styles.form} onSubmit={verifyOtp}>
            ...
            {devOtp ? <p className={styles.devOtp}>Local dev OTP: <strong>{devOtp}</strong></p> : null}
        ...
        <p className={styles.note}>
          Government identity providers require official OIDC credentials. Mobile OTP is locally signed for development until an SMS gateway is configured.
        </p>
      </section>
    </main>
  );
