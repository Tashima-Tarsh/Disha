...
export const osintSourceUniverse: OsintSourceUniverseEntry[] = [
  ...
  { id:"reliefweb", name:"ReliefWeb", category:"conflict_events", homeUrl:"https://reliefweb.int/", mode:"requires_configuration", auth:"account", risk:"low", capabilities:["humanitarian reports","disaster updates","API"], notes:"ReliefWeb API v2 requires a pre-approved appname for API use; configure before promotion." },
