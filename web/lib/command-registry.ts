...
export const dishaCommands: DishaCommand[] = [
  ...
  ...define("Entities & networks", "read", "planned", [
    ...
    ["/graph entity", "Entity graph", "Open a provenance-aware entity graph.", "/dashboard#graph"],
  ...
  ...define("Timeline", "read", "planned", [
    ["/timeline mission", "Mission timeline", "Inspect mission events over time.", "/dashboard#timeline"],
    ["/timeline entity", "Entity timeline", "Inspect time-bound entity observations."],
    ["/timeline geo", "Geographic timeline", "Inspect evidence events tied to geography.", "/dashboard#timeline"],
  ...
  ...define("System", "read", "planned", [
    ["/system health", "System health", "Inspect runtime health and dependency status.", "/system"],
    ["/system readiness", "System readiness", "Inspect production readiness and governance posture.", "/system"],
    ["/system jobs", "System jobs", "Inspect durable workflow jobs.", "/system"],
    ["/system workers", "System workers", "Inspect worker execution state.", "/system"],
    ["/system connectors", "System connectors", "Inspect connector configuration and health.", "/system"],
    ["/system geodata-status", "Geodata status", "Inspect geometry imports, versions, licenses and indexes.", "/system#geodata"],
