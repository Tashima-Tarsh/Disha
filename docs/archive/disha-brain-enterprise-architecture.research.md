...
- `disha/brain/security/`
- `disha/brain/brain/anomaly.py`
- `disha/brain/brain/risk_engine.py`
- `disha/brain/brain/decision.py`
- `web/lib/server/`
- `src/security/`
...
- `disha/brain/brain/` -> production-oriented brain modules
- `disha/brain/security/` -> security and policy foundation
...
- keep building product-grade interfaces in `web/` and `disha/mobile/`
- keep secure execution in `src/` and `disha/brain/brain/executor.py`
