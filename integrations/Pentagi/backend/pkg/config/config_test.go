...
func TestGetSecretPatterns_WithSecrets(t *testing.T) {
	cfg := &Config{
		...
		GeminiAPIKey:    "test-gemini-api-key-placeholder",
...
func TestGetSecretPatterns_PatternCompilation(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			name: "Gemini",
			config: &Config{
				GeminiAPIKey: "test-google-api-key-placeholder",
			},
		},
		{
			name: "DeepSeek",
			config: &Config{
				DeepSeekAPIKey: "test-api-key-placeholder",
			},
		},
		{
			name: "Kimi",
			config: &Config{
				KimiAPIKey: "test-api-key-placeholder",
			},
		},
		{
			name: "Qwen",
			config: &Config{
				QwenAPIKey: "test-api-key-placeholder",
			},
		},
		{
			name: "Tavily",
		...
		},
		{
			name: "OAuth",
			config: &Config{
				OAuthGoogleClientID:     "test-client-id-placeholder.apps.googleusercontent.com",
				OAuthGoogleClientSecret: "test-client-secret-placeholder",
				OAuthGithubClientID:     "test-github-client-id-placeholder",
				OAuthGithubClientSecret: "test-github-client-secret-placeholder",
			},
		},
		{
			name: "Database",
		...
		},
		{
			name: "Bedrock",
			config: &Config{
				BedrockAccessKey:    "test-aws-access-key-placeholder",
				BedrockSecretKey:    "test-aws-secret-key-placeholder",
