...
export function inkBoxPropsToCSS(props: InkStyleProps): CSSProperties {
  ...
  if (props.borderStyle) {
    ...
    if (showTop) {
      css.borderTopStyle = cssBorderStyle as any
    ...
    if (showBottom) {
      css.borderBottomStyle = cssBorderStyle as any
    ...
    if (showLeft) {
      css.borderLeftStyle = cssBorderStyle as any
    ...
    if (showRight) {
      css.borderRightStyle = cssBorderStyle as any
