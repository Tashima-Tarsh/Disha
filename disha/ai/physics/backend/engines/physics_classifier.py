...
class PhysicsClassifier:
    ...
    def __init__(self) -> None:
        ...
        self._domain_concepts: dict[str, list[str]] = {
            ...
            "Ancient & Traditional Physics": [
                "Greek atomism",
                "Aristotelian physics",
                "Vedic cosmology",
                "Chinese five elements",
            ],
            "Suppressed & Fringe Physics": [
                "aether theory",
                "cold fusion",
                "zero-point energy",
                "Tesla free energy",
    ...
    def get_domains(self) -> list[dict]:
        return [
            ...
            {
                "id": "ancient",
                "name": "Ancient & Traditional Physics",
            ...
            {
                "id": "suppressed",
                "name": "Suppressed & Fringe Physics",
        ...
        for domain, keywords in self._domain_keywords.items():
            ...
            for theory in (
                ...
                corpus.append(
                    ...
                    + " "
                    + " ".join(theory.get("concepts", []))
                )
                if domain == "Classical Physics" and theory in self._classical.get(
                    "theories", []
                ):
                    labels.append("Classical Physics")
                elif domain == "Modern Physics" and theory in self._modern.get(
                    "theories", []
                ):
