...
class SecurityPolicy:
    def __init__(self, workspace_root: str | None = None) -> None:
        self.workspace_root = Path(workspace_root or settings.allowed_workspace).resolve()

    def classify_command(self, command: UserCommand) -> tuple[RiskLevel, DecisionAction, list[str]]:
